...
Для корректной работы приложения и поиска погоды в вашем регионе необходимо установить долготу(lon) и широту(lat) местности в GET запросе в файле express-serveer/index.js
